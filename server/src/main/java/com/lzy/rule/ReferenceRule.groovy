     ...
     static Object yudingziping(BaZi bazi, CommonAlgorithm commonAlgorithm) {
         ...
         if (riGan=="甲") {
             ...
             if (riZhi=="丑") {
                 ...
                 mapResult["【日柱】"+riZhu]=[
                         "，此水底珠玉也。淘沙可以见金，生此日者，名利从劳力忧患中来。最喜有寅合亥，名曰“捞金用筛”，文武即登彼岸。如无寅筛而遇土填水落，泥污刑库，则沉沦苦海，终无用矣。运行寅午戌火土，忌行申子辰水库。"
                 ]
             ...
             if (riZhi=="子") {
                 ...
                 mapResult["【日柱】"+riZhu]=[
                         "此壬骑龙背也。壬坐在辰，名曰“魁罡”。第一要遇亥子通源，则龙可飞天。更喜天干有甲庚，枝下有卯寅，为风云际会，则活泼升腾，潜渊游泳，决应文武科第，富贵利达。盖辰多则贵，寅多则富，惟见戌无情，战野元黄，从来不爽。喜行金水木申子辰亥子丑运，忌行火土巳午未寅午戌运。      壬午，此水火既济也。上水下火，胎元生息， 《易》以既济。又为禄马同乡。只看前后孰强孰弱，然后去留舒配，或补水补火，自不难矣。匀停即富贵，失匀停即贫贱。喜忌先看偏正，后酌用舍。"
                 ]
             ...
             mapResult["【日干】"+riGan]=[
                     "癸水属阴，乃河涧川泽之水。生于卯上，盖取木生水之说。喜林木茂盛，得以溶导源流。故喜乙木吐气，以生斐然之美，所谓“风来水面时”也。人生领此，决定文章科第，仍余清逸佳致。如无乙干卯支，则无文章可许。宁有庚申、辛酉相扶，则源流亦清澈可嘉。最不利者，戊壬化火，反使利令智昏。"
             ]
             if (riZhi=="丑") {
                 mapResult["【日柱】"+riZhu]=[
