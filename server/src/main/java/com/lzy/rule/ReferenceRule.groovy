     ...
     static Object yudingziping(BaZi bazi, CommonAlgorithm commonAlgorithm) {
         ...
         if (riGan=="甲") {
             ...
             if (riZhi=="子") {
                 ...
                 mapResult["【日柱】:"+riZhu]=[
                         "此壬骑龙背也。壬坐在辰，名曰“魁罡”。第一要遇亥子通源，则龙可飞天。更喜天于有甲庚，枝下有卯寅，为风云际会，则活泼升腾，潜渊游泳，决应文武科第，富贵利达。盖辰多则贵，寅多则富，惟见戌无情，战野元黄，从来不爽。喜行金水木申子辰亥子丑运，忌行火土巳午未寅午戌运。      壬午，此水火既济也。上水下火，胎元生息， 《易》以既济。又为禄马同乡。只看前后孰强孰弱，然后去留舒配，或补水补火，自不难矣。匀停即富贵，失匀停即贫贱。喜忌先看偏正，后酌用舍。"
                 ]
