 ...
 * Time: 14:30
 */
public class SolarMode {

    private int year, month, day, hour, yearCyl, monCyl, dayCyl, hourCyl;
    private boolean leap;
    final static String chineseNumber[] = { "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二" };
    final static String lunarNumber[] = { "正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "腊月" };
    ...
    public String getLunarString() {// 返回阴历年月日
        return year + "年" + (leap ? "闰" : "") + lunarNumber[month - 1] + getChinaDayString(day);
    }

    // public static void main(String[] args) throws ParseException {
    //
    // Calendar today = Calendar.getInstance();
    // today.setTime(chineseDateFormat.parse("1988年1月1日"));
    //
    // SolarMode lunar = new SolarMode(today);
    //
    // System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) +
    // " 农历" + lunar.getLunarString());
    // }
